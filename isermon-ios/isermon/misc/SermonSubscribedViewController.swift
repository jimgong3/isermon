//
//  SermonSubscribedViewController.swift
//  isermon
//
...
class SermonSubscribedViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
...
//            })
//
//            loadSubscribedSermons(username: username, completion: {(sermons: [Sermon]) -> () in
...
//func loadSubscribedSermons(username: String? = nil, completion: @escaping (_ books: [Sermon]) -> ()){
//
